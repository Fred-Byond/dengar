...
export type Lang = "EN" | "ES" | "ZH" | "AR" | "JA";
...
export const LANGUAGES: LanguageMeta[] = [
  ...
  { code: "JA", endonym: "日本語",     bcp: "ja-JP", rtl: false, fidelity: "review-pending" },
];
...
export const UI = {
  ...
  landingTitle: {
    ...
    JA: "ルールは誰でも知っている。押し込まれているとき、それを守れる人はほとんどいない。",
  },
  landingLead: {
    ...
    JA: "AUREN は講座ではありません。あなたの話を聴き、判断のどこが崩れるかを見つけ、実際の詐欺とまったく同じ圧力をかける——AI コーチとの五分間の実践演習です。",
  },
  cred1: {
  ...
  cred2: {
    ...
    JA: "あなたについて告げられることは、すべてあなた自身の言葉から引用されます。",
  },
  cred3: {
    ...
    JA: "ここにあるものは実在せず、AUREN が実際の投資について助言することは一切ありません。",
  },
  beginBtn: {
  ...
  // ── Sign in ──────────────────────────────────────────────────────────
  authKicker: { EN: "Sign in", ES: "Iniciar sesión", ZH: "登录", AR: "تسجيل الدخول", JA: "サインイン" },
  authTitle: {
  ...
  authSub: {
    ...
    JA: "記録はパスワードではなく電話番号に紐づきます。六桁のコードをお送りします。",
  },
  phoneLabel: { EN: "Mobile number", ES: "Número de móvil", ZH: "手机号码", AR: "رقم الجوال", JA: "携帯電話番号" },
  otpLabel: { EN: "Six-digit code", ES: "Código de seis dígitos", ZH: "六位验证码", AR: "الرمز المكوّن من ستة أرقام", JA: "六桁のコード" },
  authNotice: {
    ...
    JA: "サインインすると、あなたの推論マップと再訓練キューが保存されます。これは本人確認ではありません——本人確認は後の工程で、記録の認証を希望する場合にのみ行われます。",
  },
  sendCodeBtn: { EN: "Send me a code", ES: "Enviarme un código", ZH: "发送验证码", AR: "أرسل لي رمزًا", JA: "コードを送る" },
  verifyContinueBtn: { EN: "Verify and continue", ES: "Verificar y continuar", ZH: "验证并继续", AR: "تحقّق وتابع", JA: "確認して続ける" },
  authSkip: {
  ...
  // ── Welcome + consent ────────────────────────────────────────────────
  entryKicker: { EN: "AUREN · Investor rehearsal", ES: "AUREN · Ensayo del inversor", ZH: "AUREN · 投资者演练", AR: "AUREN · تدريب المستثمر", JA: "AUREN · 投資家演習" },
  entryTitle: {
    ...
    JA: "誰かがあなたのお金を欲しがっているとき、自分がどう考えるのかをお見せします。",
  },
  entrySub: {
    ...
    JA: "五分間。あなたが話し、私が聴き、それから私が押します。ここにあるものは実在せず、あなたの発言が人格の評価に使われることはありません。",
  },
  nameLabel: { EN: "What should I call you?", ES: "¿Cómo quieres que te llame?", ZH: "我该怎么称呼你？", AR: "بماذا أناديك؟", JA: "何とお呼びすればよいですか" },
  namePlaceholder: { EN: "First name", ES: "Nombre", ZH: "名字", AR: "الاسم الأول", JA: "お名前" },
  consentTitle: { EN: "Before we start", ES: "Antes de empezar", ZH: "开始之前", AR: "قبل أن نبدأ", JA: "始める前に" },
  consent1: {
    ...
    JA: "途中で私はコーチをやめ、あなたに投資を売り込もうとする人物として振る舞い始めます。圧力をかけます。それがこの演習の目的です。",
  },
  consent2: {
    ...
    JA: "画面上部の操作でいつでもシミュレーションを終了できます。私が実際の投資について助言することはなく、現実の何かが詐欺かどうかを告げることもありません。",
  },
  startBtn: { EN: "I understand — start", ES: "Lo entiendo — empezar", ZH: "我明白了 — 开始", AR: "فهمت — ابدأ", JA: "理解しました — 始める" },
  ...
  exitSim: { EN: "Exit simulation", ES: "Salir de la simulación", ZH: "退出模拟", AR: "الخروج من المحاكاة", JA: "シミュレーションを終了" },
  protectBtn: { EN: "Protect", ES: "Protección", ZH: "保护", AR: "الحماية", JA: "プロテクト" },
  avatarStandIn: { EN: "Avatar stand-in", ES: "Avatar provisional", ZH: "数字人占位", AR: "بديل الشخصية الرقمية", JA: "アバター代替表示" },

  // ── Microphone ───────────────────────────────────────────────────────
  holdToSpeak: { EN: "Hold to speak", ES: "Mantén pulsado para hablar", ZH: "按住说话", AR: "اضغط مع الاستمرار للتحدث", JA: "押しながら話す" },
  holdTellMe: { EN: "Hold to speak — tell me about it", ES: "Mantén pulsado y cuéntamelo", ZH: "按住说话 — 讲讲你的情况", AR: "اضغط مع الاستمرار وأخبرني", JA: "押しながら話してください — 聞かせてください" },
  holdToAnswer: { EN: "Hold to answer", ES: "Mantén pulsado para responder", ZH: "按住回答", AR: "اضغط مع الاستمرار للإجابة", JA: "押しながら答える" },
  holdToRespond: { EN: "Hold to respond", ES: "Mantén pulsado para responder", ZH: "按住回应", AR: "اضغط مع الاستمرار للرد", JA: "押しながら応答する" },
  listening: { EN: "Listening — release when done", ES: "Escuchando — suelta al terminar", ZH: "正在聆听 — 说完请松开", AR: "أستمع — ارفع إصبعك عند الانتهاء", JA: "聞いています — 話し終えたら離してください" },

  // ── Reasoning map ────────────────────────────────────────────────────
  reasoningMap: { EN: "Reasoning map", ES: "Mapa de razonamiento", ZH: "推理图谱", AR: "خريطة التفكير", JA: "推論マップ" },
  railBuilding: { EN: "building", ES: "en construcción", ZH: "构建中", AR: "قيد البناء", JA: "作成中" },
  railFrozen: {
  ...
  railRevealed: { EN: "revealed", ES: "revelado", ZH: "已揭示", AR: "مكشوف", JA: "開示済み" },
  ...
  coachOpener: {
    ...
    JA: "はい。今のは私です。あの会話では二つのことが起きました。",
  },
  coachHandoff: {
    ...
    JA: "もう一度やってみましょう — 状況は別、問いは同じです。前回と似たところは何一つありません。",
  },
  exitAck: {
    ...
    JA: "シミュレーションはこれで終了です。そこにあったものは実在せず、あなたの発言が不利に扱われることもありません。進捗は保存されています。",
  },
  ackWords: {
  ...
  understandOpener: {
    ...
    JA: "それでは。検討している投資について聞かせてください。急がなくて構いません——途中で遮ることはしません。",
  },
  understandClose: {
  ...
  narrativeRehearsed: {
    ...
    JA: "WhatsApp で AI 取引システムの話が来たんです。月に一五パーセントくらい出ていて、見覚えのある創業者が推薦している動画もありました。サイトには規制を受けていると書いてあります。一万入れるつもりでした。",
  },
  stressHandoff: {
    ...
    JA: "けっこうです。では——ある人と話してもらいます。私は少し席を外します。",
  },
  ...
  evidenceChain: { EN: "Evidence chain", ES: "Cadena de evidencia", ZH: "证据链", AR: "سلسلة الأدلة", JA: "証拠の連鎖" },
  colElement: { EN: "Element", ES: "Elemento", ZH: "要素", AR: "العنصر", JA: "要素" },
  colBase: { EN: "Base", ES: "Base", ZH: "基线", AR: "الأساس", JA: "基準" },
  colPress: { EN: "Press", ES: "Presión", ZH: "受压", AR: "الضغط", JA: "加圧" },
  colCoach: { EN: "Coach", ES: "Coaching", ZH: "指导后", AR: "بعد التدريب", JA: "コーチング" },
  colNovel: { EN: "Novel", ES: "Nuevo", ZH: "新情境", AR: "سيناريو جديد", JA: "新規" },
  boundEvidence: { EN: "Bound evidence", ES: "Evidencia vinculada", ZH: "绑定证据", AR: "الدليل الموثّق", JA: "紐づけられた証拠" },
  elicitedBy: { EN: "elicited by", ES: "obtenida mediante", ZH: "由以下问题触发：", AR: "استُخلص عبر", JA: "引き出した問い" },
  failureSignatures: {
  ...
  boundTo: { EN: "Bound to", ES: "Vinculada a", ZH: "绑定于", AR: "مرتبط بـ", JA: "紐づけ先" },
  ruleFooter: {
  ...
  verdictPassHead: {
    ...
    JA: "あなたは同じ誤りを二度犯しました。それを名指ししたあと、三度目はありませんでした。",
  },
  verdictPassSub: {
    ...
    JA: "主張はそれだけです。ルールを知っているということではなく、まったく別の詐欺が同じ問いを投げたときに、あなたの振る舞いが変わったということです。",
  },
  verdictFailHead: {
    ...
    JA: "まだ転移していません — そして、次に演習するのはまさにそこです。",
  },
  verdictFailSub: {
    ...
    JA: "独立した確認についてコーチングを受けたあとも、新しい場面はそこをすり抜けました。これは正直な証拠であり、合格よりもあなたの役に立ちます。",
  },
  ...
  debriefOpener: {
    ...
    JA: "演習は以上で終わりです。何かを読む前に、私が実際に見たものをお伝えします。",
  },
  debriefRightTitle: {
  ...
  debriefRightLead: {
    ...
    JA: "まず持ちこたえた点から。圧力がかかる前に、{total} 個の推論要素のうち {n} 個を解決できていました：{list}。",
  },
  debriefRightNone: {
    ...
    JA: "心地よくない話から始めなければなりません。圧力がかかる前の段階で、きれいに解決できた推論要素は一つもありませんでした。",
  },
  debriefWrongLead: {
    ...
    JA: "そこで私はコーチをやめました。圧力が見つけたのはこれです。{defs}",
  },
  debriefWrongNone: {
    ...
    JA: "圧力の下で、あなたの発言に紐づけられる崩れは見つかりませんでした。これは本当に良い結果であり、同時に一回分のセッションでもあります。",
  },
  debriefImproveLead: {
  ...
  debriefTransferPass: {
    ...
    JA: "そして、まったく別の詐欺が同じ問いを投げたとき、あなたはそれを実行しました。評価が動く理由はそれだけです。",
  },
  debriefTransferFail: {
    ...
    JA: "まったく別の詐欺が同じ問いを投げたとき、それはやはりあなたをすり抜けました。取り繕うつもりはありません——合格よりもあなたの役に立ちます。",
  },
  debriefTransferItem: {
    ...
    JA: "失敗した場面と共通点のない状況で、圧力の下でも確認を維持した",
  },
  debriefRightNoneShort: {
    ...
    JA: "圧力が始まる前に解決できたものはなかった — それが正直な出発点です",
  },
  debriefWrongNoneShort: {
    ...
    JA: "あなたの発言に紐づけられる失敗シグネチャはありませんでした",
  },
  debriefQueue: {
    ...
    JA: "このセッションでは {n} 個の要素を検証できませんでした。次回にキューされています。そのために戻ってくる価値があります。",
  },
  debriefQueueNone: {
  ...
  debriefHandoff: {
    ...
    JA: "完全な記録はいつでもご覧いただけます。そこに並ぶ一行一行が、あなたが実際に言ったことを指しています。",
  },
  debriefRecordBtn: {
  ...
  modesSub: {
    ...
    JA: "いま行ったのは真ん中のものです。この画面を出発点にしていないのは意図的です——一度ループを通るまで、モードの一覧には意味がありません。",
  },
  modeRehearse: { EN: "Rehearse", ES: "Ensayar", ZH: "演练", AR: "التدريب", JA: "リハース" },
  modeRehearseDesc: {
    ...
    JA: "まだ見たことのない詐欺を相手にした加圧演習。実践による評価——いま完了したループです。",
  },
  modeLearn: { EN: "Learn", ES: "Aprender", ZH: "学习", AR: "التعلّم", JA: "ラーン" },
  modeLearnDesc: {
    ...
    JA: "推論マップが示す不足に合わせて進む、適応型の投資・AI リテラシー。テストはありません。",
  },
  modeProtect: { EN: "Protect", ES: "Proteger", ZH: "保护", AR: "الحماية", JA: "プロテクト" },
  modeProtectDesc: {
    ...
    JA: "実際の状況を、いま評価します。AUREN はそれが詐欺かどうかを告げません——まだ確認できていないことを告げます。",
  },
  backToRecord: { EN: "Back to my record", ES: "Volver a mi registro", ZH: "返回我的记录", AR: "العودة إلى سجلي", JA: "記録に戻る" },
  back: { EN: "Back", ES: "Volver", ZH: "返回", AR: "رجوع", JA: "戻る" },
  ...
  protectSub: {
    ...
    JA: "これが詐欺かどうかは申し上げません。まだ確認されていないことと、決める前に何をすべきかをお伝えします。",
  },
  protectSpoken: {
    ...
    JA: "お話しいただいた中に、確認されていない点が五つあります。お金を動かす前に、私ならこうします。",
  },
  unresolvedMarkers: {
  ...
  whatToDo: { EN: "What to do", ES: "Qué hacer", ZH: "该怎么做", AR: "ما ينبغي فعله", JA: "取るべき行動" },
  stopTitle: { EN: "Stop", ES: "Detente", ZH: "停", AR: "توقّف", JA: "止める" },
  verifyTitle: { EN: "Verify", ES: "Verifica", ZH: "核实", AR: "تحقّق", JA: "確認する" },
  decideTitle: { EN: "Decide", ES: "Decide", ZH: "决定", AR: "قرّر", JA: "決める" },
  stopBody: {
    ...
    JA: "確認が終わっていないあいだは送金しないでください。この状況では高リスクの兆候が五つ未解決のままです。",
  },
  decideBody: {
    ...
    JA: "本人、事業者、そして主張の内容が独立に確認されたあとで、判断に戻ってください。決めるのはあなたです——私は決めませんし、評価もしません。",
  },
  ...
  verifySub: {
    ...
    JA: "あなたの演習はそれだけで成立しています。認証は、雇用主や規制当局、金融機関が依拠できるよう、それを確認済みの本人に結びつけるものです。任意であり、ここでやめても失われるものはありません。",
  },
  vStep1: { EN: "Confirm your details", ES: "Confirma tus datos", ZH: "确认你的资料", AR: "أكّد بياناتك", JA: "情報を確認する" },
  vStep1d: {
    ...
    JA: "身分証に記載されているとおりの氏名と生年月日。",
  },
  vStep2: { EN: "Scan your document", ES: "Escanea tu documento", ZH: "扫描你的证件", AR: "امسح وثيقتك ضوئيًا", JA: "身分証を読み取る" },
  vStep2d: {
    ...
    JA: "パスポートまたは身分証。一度だけ撮影し、照合され、AUREN には保存されません。",
  },
  vStep3: { EN: "Liveness check", ES: "Prueba de vida", ZH: "活体检测", AR: "التحقق من الحضور الحي", JA: "生体確認" },
  vStep3d: {
    ...
    JA: "身分証を持っているのが本人かどうかを、短いカメラ確認で照合します。",
  },
  vStep4: { EN: "Issue certificate", ES: "Emitir el certificado", ZH: "签发证书", AR: "إصدار الشهادة", JA: "証明書を発行" },
  vStep4d: {
    ...
    JA: "あなたの投資家レディネス記録が、確認済みの本人に対して封緘されます。",
  },
  legalName: { EN: "Full legal name", ES: "Nombre legal completo", ZH: "法定全名", AR: "الاسم القانوني الكامل", JA: "戸籍上の氏名" },
  dob: { EN: "Date of birth", ES: "Fecha de nacimiento", ZH: "出生日期", AR: "تاريخ الميلاد", JA: "生年月日" },
  scanDocPrompt: {
  ...
  sealingNotice: {
    ...
    JA: "本人確認が完了しました。投資家レディネス記録をそれに対して封緘します。",
  },
  continueBtn: { EN: "Continue", ES: "Continuar", ZH: "继续", AR: "متابعة", JA: "続ける" },
  issueBtn: { EN: "Issue my certificate", ES: "Emitir mi certificado", ZH: "签发我的证书", AR: "أصدر شهادتي", JA: "証明書を発行する" },
  notNow: { EN: "Not now — back to my record", ES: "Ahora no — volver a mi registro", ZH: "暂不 — 返回我的记录", AR: "ليس الآن — العودة إلى سجلي", JA: "今はしない — 記録に戻る" },

  certifiedKicker: { EN: "Certified", ES: "Certificado", ZH: "已认证", AR: "معتمد", JA: "認証済み" },
  certifiedTitle: {
    EN: "Your record is now provable.",
    ES: "Tu registro ya es demostrable.",
    ZH: "你的记录现在可被证明。",
    AR: "صار سجلك قابلًا للإثبات.",
    JA: "あなたの記録は証明可能になりました。",
  },
  certifiedSub: {
    ...
    JA: "証拠の連鎖は変わっていません——認証は結果を良くするものではなく、それを確認済みの本人に結びつけるだけです。その区別こそが要点です。",
  },
  certLabel: {
  ...
  certIssued: { EN: "Issued", ES: "Emitido", ZH: "签发日期", AR: "تاريخ الإصدار", JA: "発行日" },
  certIdentity: { EN: "Identity", ES: "Identidad", ZH: "身份", AR: "الهوية", JA: "本人確認" },
  certIdentityValue: {
  ...
  certElements: { EN: "Elements evidenced", ES: "Elementos evidenciados", ZH: "已取证要素", AR: "العناصر الموثّقة", JA: "証拠のある要素" },
  certTransfer: { EN: "Transfer", ES: "Transferencia", ZH: "迁移", AR: "الانتقال", JA: "転移" },
  certDemonstrated: { EN: "Demonstrated", ES: "Demostrada", ZH: "已证实", AR: "مُثبت", JA: "実証済み" },
  certNotYet: { EN: "Not yet", ES: "Todavía no", ZH: "尚未", AR: "ليس بعد", JA: "未達" },
  certScope: { EN: "Scope", ES: "Alcance", ZH: "范围", AR: "النطاق", JA: "範囲" },
  certScopeValue: { EN: "Within-session", ES: "Intrasesión", ZH: "单次会话内", AR: "ضمن الجلسة", JA: "単一セッション内" },
  certRule: { EN: "Rule", ES: "Regla", ZH: "规则", AR: "القاعدة", JA: "規則" },
  certDisclaimer: {
    ...
    JA: "この証明書が証するのは演習であって投資能力ではなく、持続的な行動変容については何も主張しません。AUREN が誰かに共有することはありません——共有するかはあなたが決めます。",
  },
