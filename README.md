...
[`docs/MESSI-LIVE-Project-and-Product-Paper-v1.1.docx`](docs/MESSI-LIVE-Project-and-Product-Paper-v1.1.docx)
(v1.0 kept alongside for comparison; v1.1 opens with a "What changed" table). Each version is
generated by its `docs/paper/build-paper*.js` script — edit the script, never the document.
Browser-readable editions live in [`public/paper/`](public/paper/).
