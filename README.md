...
plan — is the Word paper at
[`docs/MESSI-LIVE-Project-and-Product-Paper.docx`](docs/MESSI-LIVE-Project-and-Product-Paper.docx)
(generated by [`docs/paper/build-paper.js`](docs/paper/build-paper.js) — edit the script, not
the document). The same paper is readable in a browser at
[`public/paper/messi-live-paper.html`](public/paper/messi-live-paper.html).
