"""
Builds public/paper/messi-live-paper.html — the reading edition of the paper.

The .docx is the source; this converts it to a self-contained web document
(mammoth for the content, this shell for the design) so the paper can be read
by tapping a link instead of downloading Word.

    npm i mammoth
    node tohtml.js docs/MESSI-LIVE-Project-and-Product-Paper.docx raw.html
    python3 docs/paper/build-reading-edition.py

Regenerate the .docx first with docs/paper/build-paper.js — never edit either
output by hand.
"""
import io, os
SP = os.path.dirname(os.path.abspath(__file__))
body = open(SP + "/body.html").read()

HEAD = r"""<title>MESSI.LIVE Paper</title>
...
<div class="bar">
  ...
  <span class="doc">Project &amp; Product Paper · v1.0</span>
...
<div class="page">
  <header class="cover">
    ...
    <dl class="meta">
      ...
      <dt>Version</dt><dd>1.0 · 13 August 2026</dd>
...
open(SP + "/messi-live-paper.html", "w").write(HEAD + body + FOOT)
print("written", round(os.path.getsize(SP + "/messi-live-paper.html") / 1024), "KB")
