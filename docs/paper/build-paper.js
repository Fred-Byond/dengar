/**
 * Builds docs/MESSI-LIVE-Project-and-Product-Paper.docx.
 *
 ...
 *   node docs/paper/build-paper.js docs/MESSI-LIVE-Project-and-Product-Paper.docx docs/paper
 */
const fs = require("fs");
...
const titlePage = [
  ...
  table(
    ["Field", "Detail"],
    [
      ["Document", "MESSI.LIVE — Project & Product Paper, v1.0"],
...
const s1 = [
  ...
  ...bullets([
    ...
    "Illustrative model at 4.2M monthly active fans: US$93.4M subscription ARR plus US$28.0M territorial partnership ARR. These are modelled illustrations of shape, not forecasts — see Section 6.6 for the assumptions and Section 6.7 for what would break them.",
  ]),

  h3("The ask"),
  ...numbered([
    "A Phase 0 working session with management to settle the seven decisions in Section 9.1 — persona scope, voice and likeness governance, reserved categories, children's policy, the response loop, memory policy, and launch territories.",
    "An exclusivity window for BYOND Asia to build the pilot in three agreed territories.",
    "Agreement in principle on the governance model in Section 7: BYOND operates the technology, management controls everything that is Lionel Messi.",
  ]),

  callout(
    "Position",
    "If management will not grant likeness and voice rights on the governance terms in Section 7, this proposal should not proceed — the platform's value is precisely that it is official. A partially authorised version is worse than none, because it invites the unofficial versions it exists to displace.",
  ),
  pageBreak(),
];
...
const s3 = [
  ...
  p("He asks how Messi kept believing when people said he was too small. Messi listens, answers, asks what is happening around it, reflects back what he heard, and confirms he understood. Five minutes later: “Thank you. I hope we speak again.”"),
  ...
  table(
    ...
    [
      ...
      ["Close", "Sees the summary, the memory, the rating", "Confirmation gates the memory; the rating gates quality; the share card drives organic acquisition"],
    ],
    [1500, 3560, 3960],
  ),

  h2("3.2 Why the session is controlled"),
  ...iia(
  ...
  h2("3.3 One Messi, every language"),
  ...
  h2("3.4 Memory: the retention engine"),
  ...
  h2("3.6 HoloMe: physical creates wonder, mobile creates scale"),
...
const s6 = [
  ...
  table(
    ...
    [
      ...
      ["03", "MESSI+ subscriptions", "24%", "Now"],
      ["04", "Category sponsorship attached to experiences", "9%", "Year 1"],
      ["05", "Messi Academy — consumer and institutional", "8%", "Year 1"],
      ["06", "Premium transactions", "6%", "Now"],
      ["07", "Commerce — merchandise, tickets, collections", "5%", "Year 1"],
      ["08", "Content licensing — airlines, hotels, schools, broadcasters", "4%", "Year 2+"],
      ["09", "Physical experiences — HoloMe, fan zones, retail", "3%", "Year 1"],
    ],
    [620, 5000, 1900, 1500],
  ),
  spacer(140),
  p("No single source carries the business. The platform monetises the same relationship repeatedly across markets."),
  ...
  h2("6.7 The two constraints that decide viability"),
...
/* ---- 7. Governance ---- */
const s7 = [
  h1("7. Governance, rights and safeguarding"),
  ...
  h2("7.1 The Global Rights Matrix"),
  ...
  h2("7.2 What management controls"),
  ...
  h2("7.4 Children and duty of care"),
  ...
  h2("7.6 Shutdown and incident protocol"),
...
const s9 = [
  ...
  h2("9.1 Phase 0 — decisions required from management"),
  ...
  h2("9.2 Twelve weeks to pilot"),
  table(
    ["Phase", "Weeks", "Deliverables"],
    [
      ["Phase 0 — Alignment", "1–2", "Seven decisions above; persona specification; script review in launch languages; rights matrix instantiated for three territories"],
      ["Phase 1 — Core build", "3–7", "Live avatar integration; booking, notification and billing; territory provisioning; children's environment; LLM scorer replacing the deterministic pass"],
      ["Phase 2 — Intelligence and hardening", "6–9", "Global Pulse against live data; World Brief automation; care queue and reviewer tooling; load and concurrency testing; security review"],
...
const s10 = [
  ...
  ...iia(
    ...
    "Proceed to a Phase 0 working session, settle the seven decisions in Section 9.1, and build the pilot in three agreed territories under an exclusivity window.",
  ),
        ...
        default: new Footer({
          children: [
            new Paragraph({
              ...
              children: [
                new TextRun({ text: "v1.0  ·  13 August 2026  ·  ", size: 16, color: MUTED }),
