...
| `mirome-interview.html` | The employee half, rebuilt by hand: a light-theme journey in **six languages** (English · Bahasa Melayu · 中文 · العربية · 한국어 · 日本語), Arabic in full RTL. Language → welcome → consent → context → pulse → ready → interview → reflection → confirmation → close |
...
"nobody is listening live" promise is the hero of the welcome screen and is
repeated immediately before the participant speaks, the consent screen shows a
